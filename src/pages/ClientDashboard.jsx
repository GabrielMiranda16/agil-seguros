  ...
  return (
    <div className="flex items-center gap-2">
      <Input ref={ref} id={id} type="date" value={value} onChange={onChange} disabled={disabled}
        className="w-full min-w-0 [&::-webkit-calendar-picker-indicator]:hidden" />
      {!disabled && (
