    ...
    <div className="flex-1 overflow-y-auto max-h-[calc(90vh-150px)] px-4 py-4">
      ...
      <div className="mt-6 pt-6 border-t">
        <div className="flex items-center justify-between mb-4">
            ...
            <Button type="button" onClick={openSolicitacaoDialog} className="bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-md hover:shadow-lg transition-all">
            ...
            <CardHeader>
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto flex-wrap justify-end">
                        ...
                        <Button onClick={openModalToAdd} className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 text-white"><Plus className="mr-2 h-4 w-4" /> Adicionar</Button>
                    </div>
                </div>
            </CardHeader>
            <CardContent>
